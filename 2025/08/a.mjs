...
const numToTake = junctions.length === 20 ? 10 : 1000;

for (const [a, b] of sortedCombinations.slice(0, numToTake)) {
...
const result = circuits.slice(0, 3).map(circuit => circuit.size).reduce((a, b) => a * b);
